...
| Sync Playwright extensions to local directory | `manyoyo playwright ext-sync --clean-tmp` |
...
| `playwright ext-sync [--prodversion] [--clean-tmp]` | Download and extract built-in extensions to plugin directory |
