(function () {
    ...
    function createContainerToggle(containerGroup, expanded) {
        ...
        title.textContent = `容器：${containerGroup && containerGroup.containerName ? containerGroup.containerName : ''}`;
        title.title = title.textContent;

        const statusText = document.createElement('div');
        statusText.className = `container-card-status ${status.tone}`;
    ...
    function createAgentRow(session, index) {
        ...
        sessionName.title = sessionName.textContent;
