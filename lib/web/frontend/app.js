(function () {
    ...
    function syncComposerExpanded() {
        ...
        const focused = document.activeElement === commandInput;
    ...
    commandInput.addEventListener('focus', syncComposerExpanded);
    commandInput.addEventListener('blur', syncComposerExpanded);
