(function () {
    ...
    const PREFER_DOM_RENDERER = /iphone|ipad|ipod|android|mobile/i.test(navigator.userAgent || '');
    ...
    function renderTerminalIntro() {
        ...
        writeTerminalLine('提示: 终端内执行 codex 时默认启用 --no-alt-screen 与低色彩兼容模式。');
    ...
    function ensureTerminalReady() {
        ...
        state.terminal.term = new window.Terminal({
            ...
            fontSize: 13,
            scrollback: 5000,
            rendererType: PREFER_DOM_RENDERER ? 'dom' : 'canvas',
