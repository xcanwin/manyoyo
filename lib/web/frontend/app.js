(function () {
    ...
    function renderContainerLevel(groups) {
        ...
        if (!groups.length) {
            ...
            empty.textContent = '暂无 manyoyo 容器';
        ...
        groups.forEach(function (containerGroup) {
            ...
            const item = createSessionCard({
                ...
                meta: `${containerGroup.sessions.length} 个 AGENT` + (containerGroup.image ? ' · ' + containerGroup.image : ''),
    ...
    function openCloneModal(mode, sourceContainerName) {
        ...
        state.cloneModal.nameDraft = `${source}-copy`;
