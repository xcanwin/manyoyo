    ...
    return await new Promise((resolve, reject) => {
        ...
        function emitStdoutTraceLine(line) {
            ...
            if (agentProgram === 'claude' || agentProgram === 'gemini' || agentProgram === 'codex' || agentProgram === 'opencode') {
                ...
                if (payload) {
                    const traceEvents = prepareStructuredTraceEvents(agentProgram, payload, structuredTraceState, STRUCTURED_TRACE_DEPS);
                    ...
                    const deltaContent = extractContentDeltaFromPayload(agentProgram, payload, STRUCTURED_TRACE_DEPS);
