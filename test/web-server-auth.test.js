...
`, 'utf-8');
    ...
    test('should expose editable-small-file and readonly-large-file behavior in file browser assets', () => {
        ...
        const loginSource = fs.readFileSync(path.join(__dirname, '../lib/web/frontend/login.js'), 'utf-8');
        ...
        expect(apiClientSource).toContain("platform.navigate('/auth/login');");
        ...
        expect(appHtmlSource).toContain('id="appBrand"');
        expect(appHtmlSource).toContain('id="terminalMobileForm"');
        ...
        expect(appSource).toContain("const WORKBENCH_STATE_STORAGE_KEY = 'manyoyo.web.workbenchState.v1';");
        expect(appSource).toContain('function sendTerminalInput(data, options) {');
        expect(appSource).toContain('window.visualViewport');
        ...
        expect(appStyleSource).toContain('.term-mobile-tools');
        expect(appStyleSource).toContain('.term-mobile-form');
        expect(appStyleSource).toContain('mobile-terminal-landscape');
        expect(loginSource).toContain("const LOGIN_HINT_STORAGE_KEY = 'manyoyo.web.loginHint.v1';");
        expect(loginSource).toContain('persistLoginHint();');
    });
